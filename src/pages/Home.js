        ...
        <Box sx={{
            ...
            <Container>
                ...
                <Grid container spacing={2}>
                    ...
                    >
                        <Slider {...bannerSlider}>
                            {GAMES.map(item => <BSlide key={item.id} item={item} />)}
                        </Slider>
                    </Grid>
                    <Grid item xs={12} md={4.5}>
                        <Link href="/nfbs" underline="none">
                ...
                <Box sx={{ pt: 4 }}>
                    ...
                    <Typography variant="body1">
                        MetaBaby is a one stop shop for all gamify needs within crypto space.
                        It aggregates and facilitates the games under one umbrella.
                        The hassle of switching websites to play multiple games will come to an end
                        by using Metababy GameFi Dapp.
                    </Typography>
                    <Box component={"br"} />
                    <Typography variant="body1">
                        It offers NFT Staking-as-a-Service and a gaming marketplace to trade in-game
                        items, NFTs of listed gaming partners.
                    </Typography>
                </Box>
                <Box sx={{
                    ["& .slick-slide"]: {
                    ...
                    <Slider {...gameSlider}>
                        {GAMES.map((item, idx) => <Games key={item.id} item={item} index={idx} />)}
                    </Slider>
                </Box>
                <Box sx={{
                    ["& .slick-slide"]: {
                ...
                <Box sx={{
                    ...
                    <Slider {...mgameSlider}>
                        {GAMES.map((item, idx) => <MGames key={item.id} item={item} index={idx} />)}
                    </Slider>
                </Box>
            </Container>
        </Box>
